...
const Footer = () => {
  const quickLinks = [
    { id: 1, title: "Home", url: "/en" },
    { id: 2, title: "About Us", url: "/en/about-us" },
    { id: 3, title: "Services", url: "/en/our-services" },
    { id: 4, title: "Cameras Contract", url: "/en/contract" },
    { id: 5, title: "Contact", url: "/en/contact-us" },
  ];
  const policies = [
    { id: 1, title: "Terms and Conditions", url: "/en/terms-and-conditions" },
    { id: 2, title: "Policy and Privacy", url: "/en/policy-and-privacy" },
    {
      id: 3,
      title: "Exchange and Return Policy",
      url: "/en/exchange-and-return-policy",
    },
  ];
  const contactInfo = [
    {
      ...
      icon: <MyLocationIcon />,
      description:
        "	Kingdom of Saudi Arabia - Jeddah - Al-Zahra Dist - Postal Code 23522",
    },
          ...
          <Box py={5}>
            <Grid container spacing={5} mb={10}>
              <Grid item xs={12} sm={6} md={3}>
                <SOS>
                  ...
                  <Typography my={2}>
                    If you want to get a service from Vision things, you can
                    contact us or through our means of communication
                  </Typography>
                  <Box display={"flex"}>
                    {socialMedia.map((e) => (
                      <Box key={e.id} mr={1}>
            ...
            <Box borderTop={"2px solid white"} pt={5}>
              <Typography textAlign={"center"}>
                © 2023 Vision Things. All Rights Reserved.
              </Typography>
            </Box>
          </Box>
        </Container>
